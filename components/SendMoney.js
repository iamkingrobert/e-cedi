  ...
  return (
    ...
    <Modal.Content maxWidth="300px" background="black" >
      ...
      <Modal.Header background="white" borderColor="black">
        {/* e-Cedi LOGOS HERE */}
        <Animatable.View iterationCount={"infinite"} animation={"pulse"} easing="ease-in-out" className="flex-row px-6 mt-3 items-center justify-center space-x-1">
      ...
      <Modal.Body>
        ...
        <FormControl mt="3">
          ...
          <TextInput placeholder='Enter e-Cedi Email' placeholderTextColor="white" className="text-white text-[13px] border border-white rounded-md p-2"/>
        </FormControl>
      </Modal.Body>
