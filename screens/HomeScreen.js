    ...
    <>
      <SafeAreaView className=" flex-1 relative bg-white  h-[100%]">
        ...
        <Animatable.View
          ...
          animation={"pulse"}
          easing="ease-in-out"
          className="flex-row px-6 mt-12 items-center justify-center space-x-1"
        >
        ...
        <View className="mt-[150px] space-y-3 px-6">
          <Text className="text-[34px] font-semibold text-center text-[#030514e8]">
            Build Wealth, the
          </Text>
          <Text className="text-[34px] font-semibold text-center text-[#05081d]">
            smart way.
          </Text>
        </View>
        <View className="mt-12 space-y-3 px-6">
          <Text className="text-[18px] text-gray-700">
            Save, send and invest money with e-Cedi, the only wealth management
            app you really need
          </Text>
        </View>
        {/* BlackStar Of Ghana */}
        ...
        <View className="flex-row mt-[120px] items-center justify-center space-x-2">
